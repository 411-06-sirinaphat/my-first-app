...
st.markdown("# :blue[📚เกมทายคำศัพท์ภาษาอังกฤษ หมวดสิ่งของเครื่องใช้ในห้องเรียน]")
...
def show_result_dialog(ans1, ans2, ans3, ans4, ans5, ans6, ans7, ans8, ans9, ans10):
    ...
    if score == 10:
        ...
        st.success("คุณอยู่ในแรงค์มาสเตอร์ (เยี่ยม)")
    elif 4 <= score <= 6:
        st.info("คุณอยู่ในแรงค์ไดมอนด์ (ปานกลาง)")
    elif 1 <= score <= 3:
        st.warning("คุณอยู่ในแรงค์แพลทินัม (ปรับปรุง)")
    else:
...
ans1 = st.text_input(
    "ข้อ 1: I use a 'p _ _ _ i _' to write in my notebook. ✏️",
...
ans3 = st.text_input(
    "ข้อ 3: I use a '_ u _ _ r' to measure the length of something. 📐",
    value=st.session_state.ans3_val,
)
ans4 = st.text_input(
    "ข้อ 4: I read a '_ _ _ k' to learn new things. 📕",
    value=st.session_state.ans4_val,
)
ans5 = st.text_input(
    "ข้อ 5: I write my notes in a '_ o _ _ b _ _ k'. 📓",
    value=st.session_state.ans5_val,
)
ans6 = st.text_input(
    "ข้อ 6: I use a '_ e _' to write with ink. ✒️",
...
ans8 = st.text_input(
    "ข้อ 8: I use '_ c i _ _ _ r _' to cut paper. ✂️",
    value=st.session_state.ans8_val,
)
ans9 = st.text_input(
    "ข้อ 9: I use 'g _ u _' to stick paper together. 🤝",
